...
(1, 'system_name', 'Watch Free AV Porn Movies'),
(2, 'site_name', 'Watch Free AV Porn Movies'),
(3, 'author', 'Avdbapi'),
(4, 'business_address', 'Avdbapi'),
(5, 'business_phone', '880170000000'),
(6, 'contact_email', 'admin@avdbapi.com'),
(7, 'system_email', 'admin@avdbapi.com'),
(8, 'system_short_name', 'avdbapi'),
...
(28, 'footer3_content', ''),
(29, 'copyright_text', 'Copyright 2030 <a href=\"#\">Avdbapi</a>'),
...
(65, 'google_application_name', 'Connect With Avdbapi'),
...
(135, 'movie_report_email', 'admin@avdbapi.com'),
(136, 'movie_request_enable', '1'),
(137, 'movie_request_email', 'admin@avdbapi.com'),
(138, 'envato_support_untill', '2030-01-01'),
...
(156, 'active_theme', 'missav'),
(157, 'active_language_id', '1'),
(158, 'disqus_short_name', 'avdbapi'),
(159, 'trial_enable', '0'),
(160, 'trial_period', '0'),
...
(NULL, 'latest_apk_url', 'https://avdbapi.com/avdbapi.apk'),
...
(NULL, 'Uncensored Leaked', 'Uncensored Leaked Movies', 'uncensored-leaked', 1, 1),
(NULL, 'Uncensored', 'Uncensored Movies', 'uncensored', 1, 1),
(NULL, 'Censored', 'Censored Movie', 'censored', 1, 1);
...
CREATE TABLE IF NOT EXISTS `videos` (
  ...
  `thumb_url` VARCHAR(255) DEFAULT NULL,  -- Thêm dấu phẩy đúng vị trí
